        ...
        <div className='container'>
          <div className="col-md-12">
            <div className="div-title text-center mb-5">
              ...
              <h3 className='wow animate__animated animate__fadeInUp'> Embark on a journey of cloud transformation and
                innovation.</h3>
            </div>
          </div>
          <div className='row'>
          ...
          <div className="row">
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  Benefit from our extensive experience in cloud solutions, ensuring a seamless transition to modern
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  Stay ahead of the curve with the latest advancements in cloud technology, guaranteeing your systems
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  Our solutions are designed to optimize scalability and efficiency, adapting to your evolving business
                  demands.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  Count on our track record of successful cloud transformations that have empowered businesses like
                  yours.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  We prioritize robust security protocols and compliance with industry standards, ensuring your data is
                  protected.
                </p>
              </div>
            </div>
        ...
        <div className='container'>
          <div className='row'>
            <div className='col-md-3 mb-4'>
              <div className='os-card wow animate__animated animate__zoomIn'>
                <div className='os-img'>
                  <img src='/assets/images/cloud-services/cloud-1.png' alt='img' className='img-fluid'/>
                </div>
                <div className='os-content'>
                  <h3>Manage Multi-Cloud
                  </h3>
                  <p>
                    Manage cloud servers, monitor resources, and implement backup solutions across multiple cloud platforms.
            ...
            <div className='col-md-3 mb-4'>
              <div className='os-card wow animate__animated animate__zoomIn'>
                <div className='os-img'>
                  <img src='/assets/images/cloud-services/cloud-2.png' alt='img' className='img-fluid'/>
                </div>
                <div className='os-content'>
                  <h3>Cloud Governance, Security, & Cost Optimization
                  </h3>
                  <p>
                    Cloud Governance, Security, & Cost Optimization
            ...
            <div className='col-md-3 mb-4'>
              <div className='os-card wow animate__animated animate__zoomIn'>
                <div className='os-img'>
                  <img src='/assets/images/cloud-services/cloud-3.png' alt='img' className='img-fluid'/>
                </div>
                <div className='os-content'>
                  <h3>Infrastructure Automation
                  </h3>
                  <p>
                    Automate infrastructure provisioning for scalable and consistent environments with Terraform and Cloud native languages.
            ...
            <div className='col-md-3 mb-4'>
              <div className='os-card wow animate__animated animate__zoomIn'>
                <div className='os-img'>
                  <img src='/assets/images/cloud-services/cloud-4.png' alt='img' className='img-fluid'/>
                </div>
                <div className='os-content'>
                  <h3>Code Pipeline (CICD Automation)
                  </h3>
                  <p>
                    Simplify the overall DevOps workflows to boost efficiency and speed up delivery.
