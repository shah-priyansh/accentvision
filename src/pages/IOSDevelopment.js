        ...
        <div className='container'>
          <div className="col-md-12">
            <div className="div-title text-center mb-5">
              ...
              <h3 className='wow animate__animated animate__fadeInUp'> When it comes to crafting exceptional iOS apps,
                our team stands out from the crowd. Here's why you should partner with us:</h3>
            </div>
          </div>
          <div className="row">
