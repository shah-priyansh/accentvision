...
const Home = () => {
  ...
  useEffect(() => {
    const cards = gsap.utils.toArray(".animation-card"); // Get all card elements
  ...
  return (
    <div className="home-content scroll-container">
      ...
      <div className="animation-card we-are-div bg-white text-primary-dark animation-div py-5">
            ...
            <div className="col-md-12">
              <div className="div-title text-center mb-5">
                ...
                <h3 className="wow animate__animated animate__fadeInUp">
                  {" "}
                  We are Your Global Elite Partner{" "}
                </h3>
              </div>
            </div>
      ...
      <div className="animation-card services-div animation-div">
        <div className="container">
          <div className="row">
            <div className="col-md-12">
      ...
      <div className="animation-card testimonial-div bg-white text-primary-dark animation-div">
        <div className="container">
          <div className="row">
            ...
            <div className="slider-div">
              ...
              >
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client2.jpeg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client4.jpeg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  ...
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client14.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  ...
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client15.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client16.webp"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client17.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client21.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client18.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client22.webp"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client19.jpg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client23.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client20.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client24.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client26.jpeg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client25.jpeg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client27.jpg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client28.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client29.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client32.webp"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                ...
                <div className="item">
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client30.jpeg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client31.png"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
                  <div className="customer-img wow animate__animated animate__zoomIn">
                    <img
                      src="/assets/images/clients/client33.jpg"
                      alt="img"
                      className="img-fluid"
                    />
                  </div>
