          ...
          <div className="row">
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <h4>Efficiency</h4>
                <p className="text-lt">
                  Count on us for rapid talent deployment, minimizing downtime and boosting productivity.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <h4>Global Reach</h4>
                <p className="text-lt">
                  Tap into a vast pool of global talent with strong technical and soft skills.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  We adapt to your unique project needs, no one-size-fits-all approach.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <p className="text-lt">
                  Our rigorous screening ensures top-notch professionals who seamlessly integrate into your team.
            ...
            <div className="col-md-4">
              <div className="services-card wow animate__animated animate__fadeInUp">
                ...
                <h4>Time & Material</h4>
                <p className="text-lt">
                  Onsite resource in the US and UK
